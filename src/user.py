...
@au.authenticator(au.token, au.check_u_id_existance)
...
@au.authenticator(au.token, au.check_name_length)
...
@au.authenticator(au.token, au.valid_email, au.email_already_used)
