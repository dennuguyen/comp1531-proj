...
'channels' : [{'channel_id' : 0, 'name' : 0, 'isprivate' : 0, 'owner_members' : [{'u_id' : 0, 'name_first' : 0, 'name_last' : 0}], 'name_last' : [{'u_id' : 0, 'name_first' : 0, 'name_last' : 0}]}], # Stores channels including details
}
